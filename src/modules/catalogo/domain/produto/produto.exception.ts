...
class NomeProdutoTamanhoMinimoInvalido extends ProdutoException {
    public constructor (message: string = 'O nome do produto não possui um tamanho mínimo válido.'){
        super(message);
...
class DescricaoProdutoTamanhoMinimoInvalido extends ProdutoException {
    public constructor (message: string = 'A descrição do produto não possui um tamanho mínimo válido.'){
    super(message);
 ...
 class DescricaoProdutoTamanhoMaximoInvalido extends ProdutoException {
    public constructor (message: string = 'A descrição do produto não possui um tamanho máximo válido.'){
    super(message);
...
class QtdMinimaCategoriasProdutoInvalida extends ProdutoException {
    public constructor (message: string = 'A quantidade mínima de categorias do produto é inválida.'){
    super(message);
